                    ...
                    <div class="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div v-for="permission in availablePermissions" :key="permission">
                            <label class="flex items-center">
                                ...
                                <span class="ml-2 text-xs text-gray-600">{{ permission }}</span>
                            </label>
                        </div>
                    </div>
                </div>
                            ...
                            <div v-for="token in tokens" :key="token.id" class="flex items-center justify-between">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <button v-if="availablePermissions.length > 0"
                                            class="cursor-pointer ml-6 text-xs text-gray-400 underline"
                                            @click="manageApiTokenPermissions(token)"
                                    >
                                        Permissions
                                    </button>

                                    <button class="cursor-pointer ml-6 text-xs text-red-500"
        ...
        <jet-dialog-modal :show="displayingToken" @close="displayingToken = false">
            ...
            <template #content>
                ...
                <div v-if="$page.props.jetstream.flash.token"
                     class="mt-4 bg-gray-100 px-4 py-2 rounded font-mono text-xs text-gray-500">
