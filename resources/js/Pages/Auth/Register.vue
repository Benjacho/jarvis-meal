    ...
    <jet-authentication-card>
        ...
        <form @submit.prevent="submit">
            <div>
                ...
                <jet-input id="name" v-model="form.name" autocomplete="name" autofocus class="mt-1 block w-full" required
                           type="text"/>
            </div>
            ...
            <div v-if="$page.props.jetstream.hasTermsAndPrivacyPolicyFeature" class="mt-4">
                <jet-label for="terms">
                    <div class="flex items-center">
                        ...
                        <div class="ml-2">
                            I agree to the <a :href="route('terms.show')" class="underline text-xs text-gray-600 hover:text-gray-900"
                                              target="_blank">Terms of
                            Service</a> and <a :href="route('policy.show')" class="underline text-xs text-gray-600 hover:text-gray-900"
            ...
            <div class="flex items-center justify-end mt-4">
                <Link :href="route('login')" class="underline text-xs text-gray-600 hover:text-gray-900">
                    Already registered?
                </Link>
